...
GENERATE_STENCIL_SETTINGS(gGEqual0, 0x0000);
GENERATE_STENCIL_SETTINGS(gGEqual1, 0x0001);
GENERATE_STENCIL_SETTINGS(gGEqual2, 0x0002);
GENERATE_STENCIL_SETTINGS(gGEqual3, 0x0003);
GENERATE_STENCIL_SETTINGS(gGEqual4, 0x0004);
GENERATE_STENCIL_SETTINGS(gGEqual5, 0x0005);
